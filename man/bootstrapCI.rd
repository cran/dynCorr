...
\examples{
      ...
      examp1.bs <- bootstrapCI(dataFrame=dynCorrData, 
                               ...
                               B = 200, percentile=c(0.025, 0.975), seed = 5)
      examp1.bs

      ## Example 2: using default smoothing parameters, obtain bootstrap CI estimates
      ##             for all three pairs of responses, for original function only, at -10 days lag,
      ##             at .01 and .99 percentiles 
      ...
      examp2.bs <- bootstrapCI(dataFrame=dynCorrData, 
                               ...
                               B = 200, percentile=c(0.01, 0.99), seed = 7)
      examp2.bs
}
